(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeJobReportComponent = /** @class */ (function () {
                function HomeJobReportComponent(orderPipe, _homejobreportservice) {
                ...
                HomeJobReportComponent.prototype.setOrder = function (value) {
                    if (this.order === value) {
                        this.reverse = !this.reverse;
                    }
                    this.order = value;
                };
                HomeJobReportComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._homejobreportservice.getJobStatus().subscribe(function (data) { return (_this.homejobreportData = data); }, function (error) {
                        if (error.status === 404) {
                ...
                return HomeJobReportComponent;
            }());
            HomeJobReportComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var ngx_order_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-order-pipe */ "./node_modules/ngx-order-pipe/fesm2015/ngx-order-pipe.js");
            var JobStatusHomeComponent = /** @class */ (function () {
                function JobStatusHomeComponent(orderPipe, _jobstatusservice) {
                    this.orderPipe = orderPipe;
                ...
                JobStatusHomeComponent.prototype.setOrder = function (value) {
                    if (this.order === value) {
                        this.reverse = !this.reverse;
                    }
                    this.order = value;
                };
                JobStatusHomeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._jobstatusservice.getJobStatus().subscribe(function (data) { return (_this.jobstatusData = data); }, function (error) {
                        if (error.status === 404) {
                            alert("This data is not available on server");
                        }
                        else {
                ...
                return JobStatusHomeComponent;
            }());
            JobStatusHomeComponent.ctorParameters = function () { return [
                { type: ngx_order_pipe__WEBPACK_IMPORTED_MODULE_3__["OrderPipe"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var EdrEditModel = /** @class */ (function () {
                function EdrEditModel(jobName, objectType, source, createdOn, createdBy, frequency, time, day, date, comment) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ScheduledJobEditComponent = /** @class */ (function () {
                function ScheduledJobEditComponent(router) {
                    this.router = router;
                    this.model = new _edredit_model__WEBPACK_IMPORTED_MODULE_3__["EdrEditModel"]("", "", "", "", "", "", "", "", "", "");
                    this.router.getCurrentNavigation().extras.state;
                }
                ScheduledJobEditComponent.prototype.ngOnInit = function () {
                    if (window.history.state.data == undefined) {
                    }
                    else {
                        var str = history.state.data;
                        var jsonData = JSON.parse(str);
                        this.model = jsonData;
                        console.log(jsonData);
                    }
                };
                return ScheduledJobEditComponent;
            }());
            ScheduledJobEditComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ScheduledJobListComponent = /** @class */ (function () {
                function ScheduledJobListComponent(_scheduledjoblistservice, router) {
                    ...
                    this.deleteJob = function () {
                        var str = this.jobRadio;
                        var jsonData = JSON.parse(str);
                        //console.log(jsonData);
                        alert("Please confirm if want to delete " + jsonData.jobName);
                    };
                }
                ScheduledJobListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._scheduledjoblistservice.getScheduledJobList().subscribe(function (data) { return (_this.scheduledjobData = data); }, function (error) {
                        if (error.status === 404) {
                            alert("This data is not available on server");
                        }
                        else {
                ...
                return ScheduledJobListComponent;
            }());
            ScheduledJobListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeJobReportService = /** @class */ (function () {
                function HomeJobReportService(http) {
                    this.http = http;
                    this._url = "/assets/data/homejobReport.json";
                }
                HomeJobReportService.prototype.getJobStatus = function () {
                    return this.http.get(this._url);
                };
                return HomeJobReportService;
            }());
            HomeJobReportService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobStatusService = /** @class */ (function () {
                ...
                JobStatusService.prototype.getJobStatus = function () {
                    return this.http.get(this._url);
                };
                return JobStatusService;
            }());
            JobStatusService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var ScheduledJobListService = /** @class */ (function () {
                function ScheduledJobListService(http) {
                    this.http = http;
                    this._url = "/assets/data/scheduledData.json";
                }
                ScheduledJobListService.prototype.getScheduledJobList = function () {
                    return this.http.get(this._url);
                };
                return ScheduledJobListService;
            }());
            ScheduledJobListService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SubmitEdrDataService = /** @class */ (function () {
                function SubmitEdrDataService(_http) {
                    this._http = _http;
                    this._url = "";
                }
                SubmitEdrDataService.prototype.submitEdrJobData = function (edrmodel) {
                    return this._http.post(this._url, edrmodel);
                };
                return SubmitEdrDataService;
            }());
            SubmitEdrDataService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var EdrModel = /** @class */ (function () {
                function EdrModel(jobName, selectCustomer, object, source, frequency, time, dayofWeek, dayofMonth, reportingLevel, email, comment) {
                    this.jobName = jobName;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SubmitEdrJobComponent = /** @class */ (function () {
                function SubmitEdrJobComponent(_submitedrdataservice) {
                ...
                SubmitEdrJobComponent.prototype.edrJobSubmit = function (submitEdrJob) {
                ...
                SubmitEdrJobComponent.prototype.weekSelector = function (value) {
                    if (value === "Weekly") {
                ...
                SubmitEdrJobComponent.prototype.ngOnInit = function () { };
                return SubmitEdrJobComponent;
            }());
            SubmitEdrJobComponent.ctorParameters = function () { return [
